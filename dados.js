let dados = [
    ...
    {
        "titulo": "A Inteligência Artificial no Trabalho",
        "descricao": "A inteligência artificial está revolucionando o mundo do trabalho. Seus algoritmos avançados permitem a automatização de tarefas repetitivas, análise de grandes volumes de dados e tomada de decisões mais precisas. Em setores como indústria, finanças e saúde, a IA tem sido fundamental para aumentar a eficiência, reduzir custos e desenvolver novos produtos e serviços. A personalização de experiências do cliente, a detecção de fraudes e a otimização da cadeia de suprimentos são apenas alguns exemplos do potencial da IA no ambiente corporativo.",
        "link": "https://www.totvs.com/blog/inovacoes/inteligencia-artificial-mercado-de-trabalho/",
        "tags": [
            "Inteligência Artificial",
            "IA",
            "Trabalho",
    ...
    {
        "titulo": "IA e Entretenimento: Novas Formas de Diversão",
        "descricao": "Além de transformar o mundo do trabalho, a inteligência artificial também está revolucionando a forma como nos divertimos. A IA está por trás de recomendações personalizadas de filmes, séries e músicas em plataformas de streaming. Além disso, está sendo utilizada para criar jogos mais realistas e imersivos, além de gerar conteúdos artísticos como músicas, pinturas e até mesmo roteiros de filmes. A inteligência artificial também está dando vida a assistentes virtuais que podem conversar conosco, contar histórias e até mesmo nos fazer companhia.",
        "link": "https://inbot.com.br/chatbots/ia-modifica-mercado/",
        "tags": [
            "Inteligência Artificial",
            "IA",
            "Entretenimento",
    ...
    {
        "titulo": "IA e Educação",
        "descricao": "A IA está transformando a educação, personalizando o aprendizado, automatizando tarefas administrativas e oferecendo novas ferramentas para professores e alunos. Essa transformação tem o potencial de tornar a educação mais acessível e eficaz.",
